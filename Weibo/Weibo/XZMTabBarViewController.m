...
- (void)viewDidLoad {
    ...
    /*添加子控制器 */
    [self setUpChildControllerWith:[[MainViewController alloc]init] norImage:[UIImage imageNamed:@"tabBar_essence_icon"] selImage:[UIImage imageNamed:@"tabBar_essence_click_icon"] title:@"首页"];
    
    [self setUpChildControllerWith:[[ViewController alloc] init] norImage:[UIImage imageNamed:@"tabBar_new_icon"] selImage:[UIImage imageNamed:@"tabBar_new_click_icon"]title:@"消息"];
    
    /** 关注 */
    [self setUpChildControllerWith:[[ViewController alloc] init] norImage:[UIImage imageNamed:@"tabBar_friendTrends_icon"] selImage:[UIImage imageNamed:@"tabBar_friendTrends_click_icon"] title:@"发现"];
    
    /** 我的 */
    [self setUpChildControllerWith:[[ViewController alloc] init] norImage:[UIImage imageNamed:@"tabBar_me_icon"] selImage:[UIImage imageNamed:@"tabBar_me_click_icon"] title:@"我"];
...
//    if([childVc.title isEqualToString:@"消息"]){
//        childVc.tabBarItem.badgeValue = @"183";
//    }
